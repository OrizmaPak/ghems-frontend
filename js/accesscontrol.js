...
const accessctrl_sales = ['SALES', 'BILLS', 'SPLIT BILL', 'ORDER', 'UPDATE ORDER', 'DELETE ORDER', 'VIEW ALL USER SALES', 'SALES REPORT', 'RECEIPT', 'NO CHARGE POSTING', 'CHAIRMAN DISCOUNT POSTING']
