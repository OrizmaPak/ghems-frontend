       <section class="animate__animated animate__fadeIn">
                            ...
                            <!--</p>-->
                             ...
                             <ul class="flex flex-wrap text-sm font-medium text-center text-gray-500 border-b border-gray-200 cark:border-gray-700 cark:text-gray-400">
                                <!--<li id="rccview" class="me-2 cp viewer" onclick="did('extendstayform').classList.add('hidden');this.children[0].classList.add('active', '!text-blue-600');did('lostandfoundview').classList.remove('hidden');this.nextElementSibling.children[0].classList.remove('active', '!text-blue-600');">-->
                                <li  class="me-2 cp updater optioner !text-blue-600 active" name="extendstayform" onclick="runoptioner(this)">
                                    <p class="inline-block p-4 rounded-t-lg hover:text-gray-600 hover:bg-gray-50">Extend Reservation</p>
                                </li> 
                                <!--<li id="" class="me-2 cp viewer optioner" name="extendstayview" onclick="runoptioner(this)">-->
                                <!--    <p class="inline-block p-4 rounded-t-lg hover:text-gray-600 hover:bg-gray-50 ">View Cancelled Reservations</p>-->
                                <!--</li>-->
                            </ul>
                                ...
                                <!--            </div>-->
                                    ...
                                    <div id="getrefform" class="">
                                        <div class="flex flex-col space-y-3 bg-white/90 p-5 xl:p-10 rounded-sm">
                                            ...
                                            <div class="flex justify-start mt-5 gap-2">
                                                <button id="openExtendStayRefPicker" type="button" class="w-full h-[40px] md:w-max text-blue-500 text-sm capitalize bg-white border border-blue-400 px-4 shadow-md font-medium hover:opacity-75 transition duration-300 ease-in-out flex items-center justify-center gap-3">
                                                    <span>Find</span>
                                                </button>
                                    ...
                                    <div id="mainform" class="hidden flex flex-col  bg-white/90 p-5 pt-0 rounded-sm">
                                      ...
                                      <span class="font-medium">Note!</span> Make changes to only the departure and save. Any other changes will be ignored.
                                    </div>
                                        ...
                                        <div class="grid grid-cols-1 !mb-2 lg:grid-cols-2 gap-10">
                                            <div class="grid grid-cols-1 !mb-2 lg:grid-cols-5 gap-10">
                                                ...
                                                <div class="form-group col-span-2 shadow-sm  bg-[#3b82f6] px-4">
                                                    <label for="logoname" class="control-label text-md text-white">departure date</label>
                                                    <input  type="datetime-local" onchange="datedifference()" name="departuredate" id="departuredate" class="bg-white form-control !p-2 comp sss" placeholder="Enter departure date">
                                                </div>
                                        ...
                                        <div id="roomfullcontainer" class="relative border rounded py-2 px-2 mt-6 !mb-2 shadow-sm">
                                        ...
                                        <div id="reservationbiller" class="grid p-2 rounded-md shadow-sm border bg-[#f5f5f5] hidde mb-6">
                                            ...
                                            <div class="grid grid-cols-1 !mb-2 lg:grid-cols-1 gap-10 p-3 ">
                                                ...
                                                <!--    <input readonly type="text" name="billto" id="billto" class="bg-white form-control !p-2 comp2" readonly placeholder="">-->
                                                <!--</div>-->
                                                <div class="form-group">
                                                    <label for="logoname" class="control-label text-md">Billing info <span class="text-xs text-[blue]" id="mindeposit"></span></label>
                                                    <!--<input readonly type="number" onchange="checkmin(this)" name="amountpaid" id="amountpaid" class="bg-white form-control !p-2 comp2" placeholder="Enter deposit amount">-->
                                            ...
                                            <div class="grid grid-cols-1 !mb-2 lg:grid-cols-2 gap-10">
                                                ...
                                                <select name="paymentmethod" id="" class="bg-white form-control !p-2 comp2">
                                            ...
                                            <div class=" border rounded p-2 !mb-2 !bg-[#f5f5f5]">
                                                ...
                                                <div class="form-group">
                                                        ...
                                                        <input readonly type="hidden" name="" id="referencer" class="bg-white form-control !p-2 comp2" placeholder="Enter special request by guest">
                                        ...
                                        <!--</div>-->
                                          <div class="flex justify-end mt-5 gap-4 h-fit">
                                                  <div class="flex w-full justify-start items-end !hidden"> 
                                        ...
                                        <div class="flex items-center gap-5 text-md border  p-4 ">
                                         ...
                                         <button onclick="did('modalformone').classList.remove('hidden')" type="button" class="m-auto w-full h-[35px] md:w-max text-blue-400 text-sm capitalize border border-2 border-blue-400 p-3 lg:py-2 shadow-md font-medium hover:opacity-75 transition duration-300 ease-in-out flex items-center justify-center gap-3">
                                            ...
                                            <span>More&nbsp;Details</span> 
                                                 ...
                                                 <button onclick="did('extendstay').click()" type="button" class="m-auto w-full h-[35px] md:w-max text-white text-sm capitalize bg-blue-400 p-3 lg:py-2 shadow-md font-medium hover:opacity-75 transition duration-300 ease-in-out flex items-center justify-center gap-3 btn-reset">
                                                    <span class="material-symbols-outlined text-lg">restart_alt</span>
                                                    <div class="btnloader" style="display: none;"></div>
                                                      <span class="text-lg">⟲</span>
                                                      <span>Reset</span> 
                                                </button>
                                                 <button id="submit" type="button" class="m-auto w-full h-[35px] md:w-max text-white text-sm capitalize bg-green-400 p-3 lg:py-2 shadow-md font-medium hover:opacity-75 transition duration-300 ease-in-out flex items-center justify-center gap-3">
                                                    <div class="btnloader" style="display: none;"></div>
                                                    <span>Save Departure</span> 
                                                </button>
                                            </div>
                            ...
                            <div class="flex justify-end w-full my-4">
                                                <!-- <button onclick="printContent('HEMS CHECKIN VIEW', null, 'extendstayview', true)" type="button" class="w-full h-[35px] md:w-max rounded-md text-white text-sm capitalize bg-gradient-to-tr from-green-400 via-green-500 to-primary-g px-8 py-3 lg:py-2 shadow-md font-medium hover:opacity-75 transition duration-300 ease-in-out flex items-center justify-center gap-3">-->
                                                <!--    <div class="btnloader" style="display: none;"></div>-->
                                                <!--    <span>print</span> -->
                                                <!--</button>-->
                                                ...
                                                <!--    <span>Export PDF</span> -->
                                                <!--</button>-->
                                                <!-- <button onclick="exportToExcel('extendstayview', 'HEMS CHECKIN VIEW')" type="button" class="w-full mx-3 h-[35px] md:w-max rounded-md text-white text-sm capitalize bg-gradient-to-tr from-blue-400 via-blue-500 to-primary-g px-8 py-3 lg:py-2 shadow-md font-medium hover:opacity-75 transition duration-300 ease-in-out flex items-center justify-center gap-3">-->
                                                <!--    <div class="btnloader" style="display: none;"></div>-->
                                                <!--    <span>Export Excel</span> -->
                                                <!--</button> -->
                                            </div>
                                    <div id="extendstayview" class="hidden">
                                    <form id="extendstayform" class="">
                                        <div class="flex flex-col space-y-3 bg-white/90 p-5 xl:p-10 rounded-sm">
                                            <div class="grid grid-cols-1 !mb-5 lg:grid-cols-2 gap-10">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input readonly type="date" name="startdate" id="arrivaldaterr" class="form-control">
                                                </div>
                                                <div class="form-group">
                                                    <label for="logoname" class="control-label">end date</label>
                                                    <input readonly type="date" name="enddate" id="arrivaldaterrr" class="form-control">
                                                </div>
                                            </div>
                                            <div class="grid grid-cols-1 !mb-5 lg:grid-cols-2 gap-10">
                                                <div class="form-group">
                                                ...
                                                <div class="flex justify-end mt-5">
                                                    <button onclick="fetchcheckinn('', 'form', 'extendstayform')" type="button" class="btn">
                                                        <div class="btnloader" style="display: none;"></div>
                                                        <span>Submit</span> 
                                                    </button>
