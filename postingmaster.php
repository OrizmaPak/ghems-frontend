            <div id="postingmastermodulewrapper" class="animate__animated animate__fadeIn">
                <ul id="postingmastermoduletabs" class="flex flex-wrap text-sm font-medium text-center text-gray-500 border-b border-gray-200 cark:border-gray-700 cark:text-gray-400 mb-3 opacity-0 pointer-events-none transition-opacity duration-150">
                    ...
                    <li class="me-2 cp" data-postingmaster-tab="postingmasterview">
                        <button type="button" class="inline-block p-4 rounded-t-lg hover:text-gray-600 hover:bg-gray-50">View Posting Master</button>
                    </li>
                    <li class="me-2 cp hidden" id="postingmastercancelformtab" data-postingmaster-tab="cancelpostingmasterform">
                        <button type="button" class="inline-block p-4 rounded-t-lg hover:text-gray-600 hover:bg-gray-50">Cancel Posting Master</button>
                    </li>
                    <li class="me-2 cp hidden" id="postingmastercancelviewtab" data-postingmaster-tab="cancelpostingmasterview">
                        <button type="button" class="inline-block p-4 rounded-t-lg hover:text-gray-600 hover:bg-gray-50">View Cancelled Posting Master</button>
                    </li>
                </ul>
           ...
           <section class="animate__animated animate__fadeIn">
                            ...
                            <!--</p>-->
                             ...
                             <ul class="hidden flex flex-wrap text-sm font-medium text-center text-gray-500 border-b border-gray-200 cark:border-gray-700 cark:text-gray-400">
                                ...
                                <li id="" class="me-2 cp viewer optioner" name="postingmasterview" onclick="runoptioner(this)">
                                    <p class="inline-block p-4 rounded-t-lg hover:text-gray-600 hover:bg-gray-50 ">View Posting Master</p>
                                </li>
                            </ul>
                                ...
                                <form id="postingmasterform" class="">
                                ...
                                <!--            </div>-->
                                    ...
                                    <div class="flex flex-col  bg-white/90 p-5 pt-0 rounded-sm">
                                        ...
                                        <div class="grid grid-cols-1 !mb-2 lg:grid-cols-2 gap-10">
                                            <div class="grid grid-cols-1 !mb-2 lg:grid-cols-5 gap-10">
                                                <div class="form-group col-span-2">
                                                    ...
                                                    <input type="datetime-local" onchange="postingMasterRecalculateCheckinFormFromDates()" name="arrivaldate" id="arrivaldate" class="bg-white form-control !p-2 comp" placeholder="Enter arrival date">
                                                </div>
                                                <div class="form-group col-span-2">
                                                    <label for="logoname" class="control-label text-md">departure date</label>
                                                    <input type="datetime-local" onchange="postingMasterRecalculateCheckinFormFromDates()" name="departuredate" id="departuredate" class="bg-white form-control !p-2 comp" placeholder="Enter departure date">
                                                </div>
                                        ...
                                        <!--            </div>-->
                                        <!--            <div class="w-full flex items-end justify-start">-->
                                        <!--                <button onclick="postingMasterOpenguestform('guest', 'guestid);did('modalform').classList.remove('hidden')" type="button" class="w-full h-[35px] bg-[#468df7] md:w-max text-white text-sm capitalize p-3 lg:py-2 shadow-md font-medium hover:opacity-75 transition duration-300 ease-in-out flex items-center justify-center gap-3">-->
                                        <!--                        <div class="btnloader" style="display: none;"></div>-->
                                        <!--                        <span>Add&nbsp;New&nbsp;Guest</span> -->
                                        <!--                </button>-->
                                        <!--            </div>-->
                                        ...
                                        <!--                        <input type="number" onchange="postingMasterHandlecheckinrate('true')" maxlength="2" name="adult" id="adult-1" class="bg-white form-control !p-2 comp" placeholder=""  oninput="enforceMaxLength(this)">-->
                                        <!--                    </div>-->
                                        <!--                    <div class="form-group">-->
                                        ...
                                        <!--                        <input type="number" onchange="postingMasterHandlecheckinrate('true')" maxlength="2" name="child" id="children-1" class="bg-white form-control !p-2 comp2" placeholder=""  oninput="enforceMaxLength(this)">-->
                                        <!--                    </div>-->
                                        <!--                    <div class="form-group">-->
                                        ...
                                        <!--                    <div class="form-group">-->
                                        <!--                        <label for="logoname" class="control-label text-md bg-white relative top-2 left-[-3px] px-2 rounded border w-fit opacity-[0.7]">adults</label> -->
                                        <!--                        <input type="number" onchange="postingMasterHandlecheckinrate('true')" maxlength="2" name="adult" id="adult-2" class="bg-white form-control !p-2 comp" placeholder=""  oninput="enforceMaxLength(this)">-->
                                        <!--                    </div>-->
                                        <!--                    <div class="form-group">-->
                                        <!--                        <label for="logoname" class="control-label text-md bg-white relative top-2 left-[-3px] px-2 rounded border w-fit opacity-[0.7]">children</label>-->
                                        <!--                        <input type="number" onchange="postingMasterHandlecheckinrate('true')" maxlength="2" name="child" id="children-2" class="bg-white form-control !p-2 comp2" placeholder=""  oninput="enforceMaxLength(this)">-->
                                        <!--                    </div>-->
                                        <!--                    <div class="form-group">-->
                                        <!--                        <label for="logoname" class="control-label text-md bg-white relative top-2 left-[-3px] px-2 rounded border w-fit opacity-[0.7]">Infants</label>-->
                                        ...
                                        <div class="flex items-center gap-5 text-md border  p-4 ">
                                            ...
                                            <input type="text"  name="totalamount" id="totalamount" class="bg-white form-control !p-2 !hidden border-none text-[blue]" readonly>
                                        ...
                                        <div class="flex items-center gap-5 text-md border  p-4 ">
                                         ...
                                         <button onclick="did('modalformone').classList.remove('hidden')" type="button" class="m-auto w-full h-[35px] md:w-max text-blue-400 text-sm capitalize border border-2 border-blue-400 p-3 lg:py-2 shadow-md font-medium hover:opacity-75 transition duration-300 ease-in-out flex items-center justify-center gap-3">
                                            ...
                                            <span>More&nbsp;Details</span>
                                                 ...
                                                 <button onclick="did('postingmaster').click()" type="button" class="m-auto w-full h-[35px] md:w-max text-white text-sm capitalize bg-red-400 p-3 lg:py-2 shadow-md font-medium hover:opacity-75 transition duration-300 ease-in-out flex items-center justify-center gap-3 btn-reset">
                                            ...
                                            <div id="viewformtoedit" class="animate__animated animate__fadeIn w-[80%] relative bg-[white] mx-auto p-10 rounded-lg shadow-lg">
                                                ...
                                                <div class="p-4 pt-0">
                                                    ...
                                                    <div class="mb-4 flex space-x-2 p-2 border rounded flex justify-center bg-[#f5f5f5]">
                                                        <span class="text-white bg-gradient-to-r from-green-400 via-green-500 to-green-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 cark:focus:ring-green-800 font-medium rounded-lg text-sm px-5 text-center me-2 mb-2">AVAILABLE</span>
                                                        <span class="text-white bg-gradient-to-r from-red-400 via-red-500 to-red-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-red-300 cark:focus:ring-red-800 font-medium rounded-lg text-sm px-5 text-center me-2 mb-2">OCCUPIED</span>
                                                        <span class="text-white bg-gradient-to-r from-yellow-400 via-yellow-500 to-yellow-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-yellow-300 cark:focus:ring-yellow-800 font-medium rounded-lg text-sm px-5 text-center me-2 mb-2">RESERVED</span>
                                                        <span class="text-white bg-gradient-to-r from-gray-400 via-gray-500 to-gray-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-gray-300 cark:focus:ring-gray-800 font-medium rounded-lg text-sm px-5 text-center me-2 mb-2">MTN BLK</span>
                                                        <!--<span class="text-white bg-gradient-to-r from-orange-400 via-orange-500 to-orange-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-orange-300 cark:focus:ring-orange-800 font-medium rounded-lg text-sm px-5 text-center me-2 mb-2">Villa Bl</span>-->
                                                        <span class="text-white bg-gradient-to-r from-purple-400 via-purple-500 to-purple-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-purple-300 cark:focus:ring-purple-800 font-medium rounded-lg text-sm px-5 text-center me-2 mb-2">MGT BLK</span>
                                                        <!--<span class="text-white bg-gradient-to-r from-blue-400 via-blue-500 to-blue-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 cark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 text-center me-2 mb-2"></span>-->
                                                    </div>
                                                    ...
                                                    <div id="roomtable" class="overflow-auto border rounded-lg">
                                                        ...
                                                        <!--                 <span class="text-white bg-gradient-to-r from-red-400 via-red-500 to-red-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-red-300 cark:focus:ring-red-800 font-medium rounded-lg text-sm px-5 text-center me-2 mb-2">23</span>-->
                                                        <!--                <span class="text-white bg-gradient-to-r from-yellow-400 via-yellow-500 to-yellow-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-yellow-300 cark:focus:ring-yellow-800 font-medium rounded-lg text-sm px-5 text-center me-2 mb-2">43</span>-->
                                                        <!--                <span class="text-white bg-gradient-to-r from-gray-400 via-gray-500 to-gray-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-gray-300 cark:focus:ring-gray-800 font-medium rounded-lg text-sm px-5 text-center me-2 mb-2">575</span>-->
                                                        <!--                <span class="text-white bg-gradient-to-r from-orange-400 via-orange-500 to-orange-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-orange-300 cark:focus:ring-orange-800 font-medium rounded-lg text-sm px-5 text-center me-2 mb-2">34</span>-->
                                                        <!--            </td>-->
                                                        <!--        </tr>-->
                            ...
                            <div class="flex justify-end w-full my-4">
                                                <!-- <button onclick="printContent('HEMS POSTING MASTER VIEW', null, 'postingmasterview', true)" type="button" class="w-full h-[35px] md:w-max rounded-md text-white text-sm capitalize bg-gradient-to-tr from-green-400 via-green-500 to-primary-g px-8 py-3 lg:py-2 shadow-md font-medium hover:opacity-75 transition duration-300 ease-in-out flex items-center justify-center gap-3">-->
                                                <!--    <div class="btnloader" style="display: none;"></div>-->
                                                <!--    <span>print</span> -->
                                                <!--</button>-->
                                                ...
                                                <!--    <span>Export PDF</span> -->
                                                <!--</button>-->
                                                <!-- <button onclick="exportToExcel('postingmasterview', 'HEMS POSTING MASTER VIEW')" type="button" class="w-full mx-3 h-[35px] md:w-max rounded-md text-white text-sm capitalize bg-gradient-to-tr from-blue-400 via-blue-500 to-primary-g px-8 py-3 lg:py-2 shadow-md font-medium hover:opacity-75 transition duration-300 ease-in-out flex items-center justify-center gap-3">-->
                                                <!--    <div class="btnloader" style="display: none;"></div>-->
                                                <!--    <span>Export Excel</span> -->
                                                <!--</button> -->
                                            </div>
                                    <div id="postingmasterview" class="hidden">
                                    <form id="postingmasterarrivalszzform" class="">
                                        <div class="flex flex-col space-y-3 bg-white/90 p-5 xl:p-10 rounded-sm">
                                            ...
                                            <div class="grid grid-cols-1 !mb-5 lg:grid-cols-2 gap-10">
                                                ...
                                                <div class="flex justify-end mt-5">
                                                     <button onclick="postingMasterFetchcheckinn('', '', 'postingmasterarrivalszzform')" type="button" class="btn">
                                                        <div class="btnloader" style="display: none;"></div>
                                                        <span>Submit</span>
                                                    </button>
                                ...
                                <div class="mb-3 px-1">
                                    <input type="text" id="postingmasterviewfrontsearch" class="form-control !p-2" placeholder="Search guest, reference, room, company/travel agency, status...">
                                </div>
