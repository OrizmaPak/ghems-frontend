       <section class="animate__animated animate__fadeIn">
                            ...
                            <!--</p>-->
                             ...
                             <ul class="flex flex-wrap text-sm font-medium text-center text-gray-500 border-b border-gray-200 cark:border-gray-700 cark:text-gray-400">
                                ...
                                <li  class="me-2 cp updater optioner !text-blue-600 active" name="guestreservationform" onclick="runoptioner(this)">
                                    <p class="inline-block p-4 rounded-t-lg hover:text-gray-600 hover:bg-gray-50">Guest & Reservations</p>
                                </li>
                                <li id="" class="me-2 cp viewer optioner" name="guestreservationview" onclick="runoptioner(this)">
                                    <p class="inline-block p-4 rounded-t-lg hover:text-gray-600 hover:bg-gray-50 ">View Guest & Reservations</p>
                                </li>
                            </ul>
                                    ...
                                    <div class="flex flex-col  bg-white/90 p-5 pt-0 rounded-sm">
                                            ...
                                            <div class="grid grid-cols-1 !mb-2 lg:grid-cols-2 gap-10">
                                             <div class="form-group">
                                                ...
                                                <div class="form-group hidden">
                                                    ...
                                                    <input type="datetime-local" name="timeline" id="timeline" class="bg-white form-control !p-2 " >
                                                </div>
                                                <div class="form-group">
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div id="modalformone" onclick="if(event.target.id == 'modalformone')this.classList.add('hidden')" class="z-[100] w-screen h-screen flex justify-center items-center fixed bg-[#5a5a5a3e] top-0 left-0 p-4 sm:p-10 overflow-auto hidden">
                                            <div id="viewformtoedit" class="animate__animated animate__fadeIn w-full sm:w-auto max-w-xl sm:max-w-2xl max-h-[90vh] overflow-y-auto relative bg-[white] p-6 sm:p-10 rounded-lg shadow-lg">
                                             <div class="w-full flex justify-end">
                                        ...
                                        <div class="flex items-center gap-5 text-md border  p-4 ">
                                            ...
                                            <input type="number" min="0" max="100" name="otherdiscount" id="otherdiscount" oninput="refreshCheckinSummaryAndTotals('other-discount-change')" class="bg-white form-control !p-2" placeholder="0-100">
                                        </div>
                                        <div class="flex items-center gap-5 text-md border  p-4 ">
                                        ...
                                        <div class="flex items-center gap-5 text-md border  p-4 ">
                                         ...
                                         <button onclick="did('modalformone').classList.remove('hidden')" type="button" class="m-auto w-full h-[35px] md:w-max text-blue-400 text-sm capitalize border border-2 border-blue-400 p-3 lg:py-2 shadow-md font-medium hover:opacity-75 transition duration-300 ease-in-out flex items-center justify-center gap-3">
                                            ...
                                            <span>More&nbsp;Details</span> 
                                                 ...
                                                 <button onclick="did('guestsreservations').click()" type="button" class="m-auto w-full h-[35px] md:w-max text-white text-sm capitalize bg-red-400 p-3 lg:py-2 shadow-md font-medium hover:opacity-75 transition duration-300 ease-in-out flex items-center justify-center gap-3 btn-reset">
                            ...
                            <div class="flex justify-end w-full my-4">
                                                <!-- <button onclick="printContent('HEMS CHECKIN VIEW', null, 'guestreservationview', true)" type="button" class="w-full h-[35px] md:w-max rounded-md text-white text-sm capitalize bg-gradient-to-tr from-green-400 via-green-500 to-primary-g px-8 py-3 lg:py-2 shadow-md font-medium hover:opacity-75 transition duration-300 ease-in-out flex items-center justify-center gap-3">-->
                                                <!--    <div class="btnloader" style="display: none;"></div>-->
                                                <!--    <span>print</span> -->
                                                <!--</button>-->
                                                ...
                                                <!--    <span>Export PDF</span> -->
                                                <!--</button>-->
                                                <!-- <button onclick="exportToExcel('guestreservationview', 'HEMS CHECKIN VIEW')" type="button" class="w-full mx-3 h-[35px] md:w-max rounded-md text-white text-sm capitalize bg-gradient-to-tr from-blue-400 via-blue-500 to-primary-g px-8 py-3 lg:py-2 shadow-md font-medium hover:opacity-75 transition duration-300 ease-in-out flex items-center justify-center gap-3">-->
                                                <!--    <div class="btnloader" style="display: none;"></div>-->
                                                <!--    <span>Export Excel</span> -->
                                                <!--</button> -->
                                            </div>
                                    <div id="guestreservationview" class="hidden">
                                    <form id="guestreservationsform" class="">
                                        <div class="flex flex-col space-y-3 bg-white/90 p-5 xl:p-10 rounded-sm">
                                            ...
                                            <div class="grid grid-cols-1 !mb-5 lg:grid-cols-2 gap-10">
                                                ...
                                                <div class="flex justify-end mt-5">
                                                    <button id="fetchgandres" onclick="fetchcheckinn('', 'form', 'guestreservationsform')" type="button" class="btn">
                                                        <div class="btnloader" style="display: none;"></div>
                                                        <span>Submit</span> 
                                                    </button>
