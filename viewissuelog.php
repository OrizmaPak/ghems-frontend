       <section class="animate__animated animate__fadeIn relative">
                            ...
                            <form id="viewissuelogform">
                                <div class="flex flex-col space-y-3 bg-white/90 p-5 xl:p-10 rounded-sm">
                                        <div class="form-group">
                                            <label for="logoname" class="control-label">Type of issue</label>
                                            <select name="typeofissue" id="issuetype" class="form-control">
                            ...
                            <div id="viewissuelogmodal" onclick="if(event.target.id === 'viewissuelogmodal')this.classList.add('hidden')" class="hidden w-full h-full bg-[#0000004a] fixed top-0 left-0 overflow-y-auto flex justify-center items-start">
                                <div class="w-fit max-w-[90%] mt-8 min-w-[500px] h-fit min-h-[400px] bg-white p-2 rounded-md shadow-lg">
                                    ...
                                    <div class="w-full py-2 flex justify-between">
                                        ...
                                        <span onclick="document.getElementById('viewissuelogmodal').classList.add('hidden')" class="cp material-symbols-outlined group-hover:text-primary-g"
