                            ...
                            <form id="buildform">
                                ...
                                <div class="grid grid-cols-1  lg:grid-cols-1 gap-10 p-3 bg-[#3b82f6] text-white rounded shadow-sm">
                                    ...
                                    <div id="" class="load hidden">
                                            <div class="form-group">
                                                <label for="logoname" class="control-label">build date</label>
                                        ...
                                        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-10 !mb-7">
                                            <div class="form-group">
                                                <label for="logoname" class="control-label">Build</label>
                                            ...
                                            <div class="flex justify-end mt-5">
                                                 <button id="" onclick="addbuilditem()" type="button" class="w-full md:w-max rounded-md text-white text-sm capitalize bg-gradient-to-tr from-green-400 via-green-500 to-primary-g px-8 py-3 lg:py-2 shadow-md font-medium hover:opacity-75 transition duration-300 ease-in-out flex items-center justify-center gap-3">
