  <ul class="flex flex-wrap text-sm font-medium hidden text-center text-gray-500 border-b border-gray-200 dark:border-gray-700 dark:text-gray-400">
                                ...
                                <li id="" class="me-2 cp viewer optioner !text-blue-600 active" name="paymentview" onclick="runoptioner(this)">
                                    <p class="inline-block p-4 rounded-t-lg hover:text-gray-600 hover:bg-gray-50 ">View Payment</p>
                                </li>
                                <li id="iddformform" class="me-2 cp updater optioner" name="paymentformdiv" onclick="runoptioner(this)">
                                    <p class="inline-block p-4 rounded-t-lg hover:text-gray-600 hover:bg-gray-50">Payment</p>
                                </li>
                            </ul>
    <p class="page-title">
        <span>Payment</span>
