       <section class="animate__animated animate__fadeIn">
                            ...
                            <!--</p>-->
                             ...
                             <ul class="flex flex-wrap text-sm font-medium text-center text-gray-500 border-b border-gray-200 cark:border-gray-700 cark:text-gray-400">
                                ...
                                <li id="" class="me-2 cp viewer optioner" name="cancelpostingmasterview" onclick="runoptioner(this)">
                                    <p class="inline-block p-4 rounded-t-lg hover:text-gray-600 hover:bg-gray-50 ">View Cancelled Posting Masters</p>
                                </li>
                            </ul>
                                ...
                                <form id="cancelpostingmasterform" class="">    
                                    ...
                                    <div id="getrefform" class="">
                                        <div class="flex flex-col space-y-3 bg-white/90 p-5 xl:p-10 rounded-sm">
                                            <div class="grid grid-cols-1 !mb-5 lg:grid-cols-4 gap-5">
                                                <div class="form-group col-span-3">
                                                    <label for="logoname" class="control-label">Posting Master Ref</label>
                                                    <input type="text" name="" id="reference" class="sss form-control" >
                                                </div>
                                            <div class="flex justify-start mt-5 gap-2">
                                                <button id="openCancelReservationRefPicker" type="button" class="w-full h-[40px] md:w-max text-blue-500 text-sm capitalize bg-white border border-blue-400 px-4 shadow-md font-medium hover:opacity-75 transition duration-300 ease-in-out flex items-center justify-center gap-3">
                                                    <span>Find</span>
                                                </button>
  ...
  <span class="font-medium">Note!</span> Changes here will apply to the cancellation
                                                        ...
                                                        <button id="submit" type="button" class="m-auto w-full h-[35px] md:w-max text-white text-sm capitalize bg-red-400 p-3 lg:py-2 shadow-md font-medium hover:opacity-75 transition duration-300 ease-in-out flex items-center justify-center gap-3">
                                                            <div class="btnloader" style="display: none;"></div>
                                                            <span>Cancel&nbsp;Posting&nbsp;Master</span> 
                                                        </button>
                                                </div>
                                        ...
                                        <div class="flex items-center gap-5 text-md border  p-4 ">
                                         ...
                                         <button onclick="did('modalformone').classList.remove('hidden')" type="button" class="m-auto w-full h-[35px] md:w-max text-blue-400 text-sm capitalize border border-2 border-blue-400 p-3 lg:py-2 shadow-md font-medium hover:opacity-75 transition duration-300 ease-in-out flex items-center justify-center gap-3">
                                            ...
                                            <span>More&nbsp;Details</span> 
                                                 ...
                                                 <button onclick="did('cancelpostingmaster').click()" type="button" class="m-auto w-full h-[35px] md:w-max text-white text-sm capitalize bg-blue-400 p-3 lg:py-2 shadow-md font-medium hover:opacity-75 transition duration-300 ease-in-out flex items-center justify-center gap-3 btn-reset">
                            ...
                            <div class="flex justify-end w-full my-4">
                                                <!-- <button onclick="printContent('HEMS CHECKIN VIEW', null, 'cancelpostingmasterview', true)" type="button" class="w-full h-[35px] md:w-max rounded-md text-white text-sm capitalize bg-gradient-to-tr from-green-400 via-green-500 to-primary-g px-8 py-3 lg:py-2 shadow-md font-medium hover:opacity-75 transition duration-300 ease-in-out flex items-center justify-center gap-3">-->
                                                <!--    <div class="btnloader" style="display: none;"></div>-->
                                                <!--    <span>print</span> -->
                                                <!--</button>-->
                                                ...
                                                <!--    <span>Export PDF</span> -->
                                                <!--</button>-->
                                                <!-- <button onclick="exportToExcel('cancelpostingmasterview', 'HEMS CHECKIN VIEW')" type="button" class="w-full mx-3 h-[35px] md:w-max rounded-md text-white text-sm capitalize bg-gradient-to-tr from-blue-400 via-blue-500 to-primary-g px-8 py-3 lg:py-2 shadow-md font-medium hover:opacity-75 transition duration-300 ease-in-out flex items-center justify-center gap-3">-->
                                                <!--    <div class="btnloader" style="display: none;"></div>-->
                                                <!--    <span>Export Excel</span> -->
                                                <!--</button> -->
                                            </div>
                                    <div id="cancelpostingmasterview" class="hidden">
                                    <form id="cancelpostingmasterformfilter" class="">
                                        <div class="flex flex-col space-y-3 bg-white/90 p-5 xl:p-10 rounded-sm">
                                            ...
                                            <div class="grid grid-cols-1 !mb-5 lg:grid-cols-2 gap-10">
                                                ...
                                                <div class="flex justify-end mt-5">
                                                    <button onclick="postingMasterFetchcheckinn('', '', 'cancelpostingmasterformfilter') " type="button" class="btn">
                                                        <div class="btnloader" style="display: none;"></div>
                                                        <span>Submit</span> 
                                                    </button>
