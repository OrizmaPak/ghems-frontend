        ...
        <section class="animate__animated animate__fadeIn max-w-full">
            ...
            <ul class="flex flex-wrap text-sm font-medium text-center text-gray-500 border-b border-gray-200 cark:border-gray-700 cark:text-gray-400">
                                ...
                                <li  class="me-2 cp updater optioner !text-blue-600 active" name="checkoutcontainer" onclick="runoptioner(this)">
                                    <p class="inline-block p-4 rounded-t-lg hover:text-gray-600 hover:bg-gray-50">Late Checkout</p>
                                </li>
                                <li id="" class="me-2 cp viewer optioner" name="checkoutview" onclick="runoptioner(this)">
                                    <p class="inline-block p-4 rounded-t-lg hover:text-gray-600 hover:bg-gray-50 ">View Late Checkouts</p>
                                </li>
                            </ul>
                                ...
                                <div class="table-content">
                                    ...
                                    <div class="flex flex-wrap gap-10 justify-end items-end pr-5">
                                        <div class="form-group pl-6">
                                                <label for="balance_display" class="control-label text-md ">Room Payment <span id="roompaymentdue" class="text-xs text-blue-600"></span></label>
                                        ...
                                        <div class="form-group pl-6">
                                                <label for="otherbills_display" class="control-label text-md ">Other Bills Payment <span id="otherbillsdue" class="text-xs text-blue-600"></span></label>
            ...
            <div class="table-content  lg:max-w-full">
              ...
              <div id="modalcheckout" onclick="if(event.target.id == 'modalcheckout')this.classList.add('hidden');did('latecheckout').click()" class="!z-[100] w-screen h-screen fixed bg-[#5a5a5a3e] top-0 left-0 p-10 overflow-auto hidden">
