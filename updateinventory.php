                             ...
                             <div >
                                <div class="table-content">
                                    ...
                                    <div class="grid grid-cols-1 lg:grid-cols-6 gap-6">
                                        ...
                                        <div class="flex justify-end mt-5">
                                             <button id="selectall" type="button" class="w-full md:w-max rounded-md text-black text-sm capitalize bg-gradient-to-tr from-white via-white to-white px-8 py-3 lg:py-2 shadow-md font-medium hover:opacity-75 transition duration-300 ease-in-out flex items-center justify-center gap-3">
                                                <div class="btnloader" style="display: none;"></div>
                                                <span>Select All</span>
                                            </button>
                                        </div>
                                        <div class="flex justify-end mt-5">
                                             <button id="deselectall" type="button" class="w-full md:w-max rounded-md text-black text-sm capitalize bg-gradient-to-tr from-white via-white to-white px-8 py-3 lg:py-2 shadow-md font-medium hover:opacity-75 transition duration-300 ease-in-out flex items-center justify-center gap-3">
                                                <div class="btnloader" style="display: none;"></div>
                                                <span>De-Select All</span>
                                            </button>
                                        </div>
                                        <div class="flex justify-end mt-5">
                                             <button id="delete" type="button" class="w-full opacity-[0.5] md:w-max rounded-md text-white text-sm capitalize px-8 py-3 lg:py-2 bg-gradient-to-tr from-[red] via-[red] to-white shadow-md font-medium hover:opacity-75 transition duration-300 ease-in-out flex items-center justify-center gap-3">
                                                <div class="btnloader" style="display: none;"></div>
