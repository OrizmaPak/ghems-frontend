       <section class="animate__animated animate__fadeIn">
                            ...
                            <ul class="flex flex-wrap text-sm font-medium text-center text-gray-500 border-b border-gray-200 dark:border-gray-700 dark:text-gray-400">
                                ...
                                <li id="" class="me-2 cp viewer optioner !text-blue-600 active" name="salesreportposform" onclick="runoptioner(this)">
                                    <p class="inline-block p-4 rounded-t-lg hover:text-gray-600 hover:bg-gray-50 ">Sales History</p>
                                </li>
                                <li class="me-2 cp updater  optioner" name="" onclick="runoptioner(this)">
                                    <p class="inline-block p-4 rounded-t-lg hover:text-gray-600 hover:bg-gray-50">--</p>
                                </li>
                            </ul>
                        
                                </div>
                            <form id="salesreportposform">
                            ...
                            <div id="salesreportposmodal" onclick="if(event.target.id === 'salesreportposmodal')this.classList.add('hidden')" class="hidden w-full h-full bg-[#0000004a] fixed top-0 left-0 overflow-y-auto flex justify-center items-start">
                                <div class="w-fit max-w-[90%] mt-8 min-w-[500px] h-fit min-h-[400px] bg-white p-2 rounded-md shadow-lg flex flex-col items-center">
                                    ...
                                    <div class="w-full py-2 flex justify-between mx-8">
                                        ...
                                        <span onclick="document.getElementById('salesreportposmodal').classList.add('hidden')" class="cp material-symbols-outlined text-red-600 group-hover:text-primary-g"
                                           style="font-size: 20px;">close</span>
                                    </div>
