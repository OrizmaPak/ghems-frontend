        ...
        <section class="animate__animated animate__fadeIn max-w-full">
            ...
            <ul class="flex flex-wrap text-sm font-medium text-center text-gray-500 border-b border-gray-200 dark:border-gray-700 dark:text-gray-400">
                                ...
                                <li id="" class="me-2 cp viewer optioner !text-blue-600 active" name="posreceiptview" onclick="runoptioner(this)">
                                    <p class="inline-block p-4 rounded-t-lg hover:text-gray-600 hover:bg-gray-50 ">View Receipts</p>
                                </li>
                                <li id="iddformform" class="me-2 cp updater optioner" name="posreceiptformdiv" onclick="runoptioner(this)">
                                    <p class="inline-block p-4 rounded-t-lg hover:text-gray-600 hover:bg-gray-50">Receipt</p>
                                </li>
                            </ul>
                    
                    <div id="posreceiptformdiv" class="grid hidden grid-cols-1 lg:grid-cols-1 gap-7 w-full mx-autoxl :border overflow-auto rounded py-14 px-7 drop-shadow-sm pt-4">
                        <div class=" grid grid-cols-1 lg:grid-cols-1 gap-7 w-full mx-auto xl:border overflow-auto rounded">
                            <div class="w-full">
                                <form id="posreceiptform" class=" ">
                                <!--<form id="getrefform" class="">-->
                                <div class="grid grid-cols-1 !mb-5 lg:grid-cols-2 gap-7  bg-white/90 p-5 w-full rounded-sm">
                                    <div class="grid grid-cols-1 !mb-5 lg:grid-cols-1 gap-10">
                                        <div class="form-group">
                                                <label for="logoname" class="control-label">Apply To</label>
                                                <select onchange="getposreceiptbalance()" name="applyto" id="applyto" class="form-control comp" >
                                            ...
                                            <div class="form-group rounded" id="receipttocontainer">
                                                <label for="logoname" class="control-label">reciept to</label>
                                                <input autocomplete="off" type="text" name="" id="receiptto1" class="form-control comp" onchange="checkdatalist(this, 'receiptto');getposreceiptbalance();" placeholder="">
                                                <input type="text" name="receiptto" id="receiptto" class="form-control hidden" placeholder="">
                                            </div>
                                    </div>
                                     ...
                                     <div class="px-7 lg:px-14 py-4 lg:py-8 bg-blue-400 text-white flex flex items-center">
                                         <div class="form-group ">
                                                ...
                                                <label id="bal" class="control-label text-bold text-xl">0.00</label>
                                ...
                                <div class="flex flex-col space-y-3 bg-white/90 p-5 xl:p-10 rounded-sm">
                                    <div class="grid grid-cols-1 !mb-5 lg:grid-cols-2 gap-10">
                                        <div class="form-group ">
                                            ...
                                            <input type="text" name="amountpaid" id="amountpaid" disabled class="form-control comp"  >
                                        </div>
                                         <div class="form-group">
                        ...
                        <div class="hidden">
                            <div class="w-full flex flex-col items-center">
                                <div class="w-80 rounded bg-gray-50 px-6 pt-8 shadow-lg" id="displaydetails">
                                    ...
                                    <!--    <span class="text-gray-400">posReceipt No.:</span>-->
                                    <!--    <span>#5033</span>-->
                                    <!--  </p>-->
                                    <!--  <p class="flex justify-between">-->
                    ...
                    <div id="posreceiptview" class="">
                        <form id="posreceiptviewform">
                                    <div class="flex flex-col space-y-3 bg-white/90 p-5 xl:p-10 rounded-sm">
                                        ...
                                        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                                            ...
                                            <div class="flex justify-end mt-5">
                                                 <button id="submitview" type="button" class="btn">
                                                    <div class="btnloader" style="display: none;"></div>
                                                    <span>Submit</span>
                                                </button>
               ...
               <div id="modalposreceipt" onclick="if(event.target.id == 'modalposreceipt')this.classList.add('hidden');did('posreceipt').click()" class="!z-[100] w-screen h-screen fixed bg-[#5a5a5a3e] top-0 left-0 p-10 overflow-auto hidden">
                               
                               <div id="viewformtoeditposreceipt" class="animate__animated animate__fadeIn w-[80%] bg-white w-fit mx-auto relative p-10 rounded-lg shadow-lg">
