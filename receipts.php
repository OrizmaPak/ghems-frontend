        ...
        <section class="animate__animated animate__fadeIn max-w-full">
            ...
            <!--<div id="" class="bg-white xl:border !max-w-[100%] overflow-auto rounded py-14 px-7 drop-shadow-sm pt-4">-->
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-7 w-full mx-autoxl :border overflow-auto rounded py-14 px-7 drop-shadow-sm pt-4">
                                ...
                                <div class="flex flex-col space-y-3 bg-white/90 p-5 rounded-sm">
                                    <div class="grid grid-cols-1 !mb-5 lg:grid-cols-4 gap-10">
                                        <div class="form-group col-span-3">
                                            ...
                                            <input type="text" name="" id="referencer" class="form-control" >
                                        </div>
                                        <div class="flex items-end">
                                            <button id="submitref" type="button" class="w-full h-[40px] md:w-max text-white text-sm capitalize bg-blue-400 px-4 py-1 lg:py-2 shadow-md font-medium hover:opacity-75 transition duration-300 ease-in-out flex items-center justify-center gap-3">
                                ...
                                <div class="flex flex-col space-y-3 bg-white/90 p-5 xl:p-10 rounded-sm">
                                    <div class="grid grid-cols-1 !mb-5 lg:grid-cols-1 gap-10">
                                        ...
                                        <div class="flex justify-end gap-6">
                                            <button onclick="did('receipts').click()" type="button" class="m-auto w-full h-[35px] md:w-max text-white text-sm capitalize bg-red-400 p-3 lg:py-2 shadow-md font-medium hover:opacity-75 transition duration-300 ease-in-out flex items-center justify-center gap-3 btn-reset">
               ...
               <div id="modalreceipt" onclick="if(event.target.id == 'modalreceipt')this.classList.add('hidden');did('receipts').click()" class="!z-[100] w-screen h-screen fixed bg-[#5a5a5a3e] top-0 left-0 p-10 overflow-auto hidden">
                               
                               <div id="viewformtoeditreceipt" class="animate__animated animate__fadeIn w-[80%] bg-white w-fit mx-auto relative p-10 rounded-lg shadow-lg">
                                   
                                   
                           <!--    <div class="flex flex-col justify-center items-center gap-2" >-->
                           <!--         <div>-->
                        			<!--	<div class="flex justify-end phide">-->
                        			<!--	<div onclick="printContent('HEMS RECEIPT', null, 'sdklfjnll', true)" class="relative mr-4 inline-block">-->
